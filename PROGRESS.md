...
артефакт [«Прототип тренировки слов»](https://claude.ai/code/artifact/fdc6566a-47e1-4388-96cb-7cf79ff7dd4c)
...
[«Тренировка — пропуск в фразе + тап по соседним словам»](https://claude.ai/code/artifact/855edf2e-59a1-4941-8469-0a855f0ee5b2),
версия 2 — HTML лежит в блобе публикации, при желании форкнуть скачать по
ссылке):
...
[«Тренировка — откуда брать фразу для упражнения»](https://claude.ai/code/artifact/0daecbae-7f74-4972-8cbb-5512d12c0085)
...
[«Тренировка — как действия ложатся в «Знаю/не знаю»»](https://claude.ai/code/artifact/55480285-11d8-4bc3-b880-7d7f9e5ecd53)):
...
### Ссылки на все артефакты сессии по тренировке (полные HTML, интерактивные)
- https://claude.ai/code/artifact/fdc6566a-47e1-4388-96cb-7cf79ff7dd4c — старый прототип (2026-07-24), формат «перевод целиком», частично устарел (см. выше про смену формата на клоуз)
- https://claude.ai/code/artifact/0daecbae-7f74-4972-8cbb-5512d12c0085 — варианты источника фразы (обрезка / переписать / как есть) на 5 реальных словах
- https://claude.ai/code/artifact/855edf2e-59a1-4941-8469-0a855f0ee5b2 — финальный экран упражнения (клоуз + тап по словам + подсказка-тоггл), v2 — актуальная версия
- https://claude.ai/code/artifact/55480285-11d8-4bc3-b880-7d7f9e5ecd53 — карта «действие → вердикт → изменение расписания» (SM-2)
